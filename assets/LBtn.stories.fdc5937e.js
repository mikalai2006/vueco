var I=Object.defineProperty;var a=(t,e)=>I(t,"name",{value:e,configurable:!0});import"./jsx-runtime.8f55439d.js";import{c as n,A as T,C as m,S as r,M as S,a as d}from"./Props.1c386f63.js";import"./iframe.42a69c0e.js";import{a as c}from"./vue.esm-bundler.63e44d6a.js";import{_ as o,L as b}from"./FButton.705b3556.js";import{L as u}from"./LIcon.a931258d.js";import{_ as h}from"./FSpinner.cdad262e.js";import"./string.cdabb4ae.js";import"./es.map.constructor.c3ec749b.js";import"./es.number.to-fixed.c01be8d7.js";import"./_plugin-vue_export-helper.cdc0426e.js";import"./ripple.4234d591.js";function v(){return v=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var l=arguments[e];for(var i in l)Object.prototype.hasOwnProperty.call(l,i)&&(t[i]=l[i])}return t},v.apply(this,arguments)}a(v,"_extends");const s="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zm.995-14.901a1 1 0 1 0-1.99 0A5.002 5.002 0 0 0 3 6c0 1.098-.5 6-2 7h14c-1.5-1-2-5.902-2-7 0-2.42-1.72-4.44-4.005-4.901z",K="M5.929 1.757a.5.5 0 1 0-.858-.514L2.217 6H.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h.623l1.844 6.456A.75.75 0 0 0 3.69 15h8.622a.75.75 0 0 0 .722-.544L14.877 8h.623a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1.717L10.93 1.243a.5.5 0 1 0-.858.514L12.617 6H3.383L5.93 1.757zM4 10a1 1 0 0 1 2 0v2a1 1 0 1 1-2 0v-2zm3 0a1 1 0 0 1 2 0v2a1 1 0 1 1-2 0v-2zm4-1a1 1 0 0 1 1 1v2a1 1 0 1 1-2 0v-2a1 1 0 0 1 1-1z",B=a(t=>({components:{FButton:o},setup(){return{args:t}},template:'<FButton v-bind="args" class="capitalize">{{ args.mode }}</FButton>'}),"Template"),P={iBell:s,Template:B},D="wrapper";function L({components:t,...e}){return n(D,v({},P,e,{components:t,mdxType:"MDXLayout"}),n(S,{title:"components/Buttons",component:o,subcomponents:{LBtn:b},argTypes:{as:{options:["a","div","button"]},mode:{options:["primary","second","danger"]}},mdxType:"Meta"}),n("h1",null,"FButton"),n("h2",null,"Playground"),n("p",null,"Change properties to see them in action"),n(m,{mdxType:"Canvas"},n(r,{name:"Playground",args:{as:"a",mode:"second"},mdxType:"Story"},B.bind({}))),n(d,{story:"Playground",mdxType:"ArgsTable"}),n("h2",null,"WithTooltip"),n("p",null,"Change properties to see them in action"),n(m,{mdxType:"Canvas"},n(r,{name:"WithTooltip",args:{},mdxType:"Story"},l=>({components:{FButton:o,LIcon:u},setup(){return{iBell:s,args:l}},template:`
          <div>
      ...
      `})),n(d,{story:"FButton",mdxType:"ArgsTable"}),n(m,{mdxType:"Canvas"},n(r,{name:"FButtonWithSpinner",args:{},mdxType:"Story"},l=>({components:{FButton:o,FSpinner:h},setup(){const i=c(!1);return{args:{...l},iBell:s,pressed:i}},template:`
        <FButton v-bind="args" v-model:pressed="pressed">
          <div class="flex items-center">
            <FSpinner role="presentation" class="mr-2" /> Load
          </div>
        </FButton>
        `}))),n(d,{story:"FButtonWithSpinner",mdxType:"ArgsTable"}))}a(L,"MDXContent");L.isMDXComponent=!0;const F=B.bind({});F.storyName="Playground";F.args={as:"a",mode:"second"};F.parameters={storySource:{source:`args => {
  return {
    components: {
      FButton
    },
    ...
    template: '<FButton v-bind="args" class="capitalize">{{ args.mode }}</FButton>'
  };
...
}`}};const x=a(t=>({components:{FButton:o,FSpinner:h},setup(){const e=c(!1);return{args:{...t},iBell:s,pressed:e}},template:`
        <FButton v-bind="args" v-model:pressed="pressed">
          <div class="flex items-center">
            <FSpinner role="presentation" class="mr-2" /> Load
          </div>
        </FButton>
        `}),"fButtonWithSpinner");x.storyName="FButtonWithSpinner";x.args={};x.parameters={storySource:{source:`args => {
  return {
    components: {
      FButton,
      FSpinner
