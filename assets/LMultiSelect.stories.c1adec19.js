var L=Object.defineProperty;var l=(n,r)=>L(n,"name",{value:r,configurable:!0});import{r as t}from"./vue.esm-bundler.4710087e.js";import{_ as c}from"./FMultiSelect.c3cb141c.js";import{_ as m,a as p}from"./FText.a26618ee.js";import{L as u,a as f}from"./LForm.376d926c.js";import{L as v}from"./LIcon.9826c8a0.js";import{i as b,a as h,b as g}from"./useIcon.48b70701.js";import"./LSpinner.94cc8f29.js";const T={parameters:{storySource:{source:`import { ref } from "vue";
...
`,locationsMap:{"input-multi-select":{startLoc:{col:16,line:43},endLoc:{col:2,line:179},startBody:{col:16,line:43},endBody:{col:2,line:179}},"inputwith-image-multi-select":{startLoc:{col:19,line:216},endLoc:{col:2,line:362},startBody:{col:19,line:216},endBody:{col:2,line:362}}}}},title:"Components/FMultiSelect",component:c},x={id:"friends",name:"friends",component:"FMultiSelect",keyValue:"id",keyLabel:"name",keyGroup:"username",autofocus:!0,multiple:!0,label:"Your friends",description:"Choose friends your know",placeholder:"Choose friends",items:[],vtype:"array",rules:[{type:"required",params:["This field is required"]},{type:"length",params:[1,"Languages cannot be less than 1 language"]}]},k=l(n=>({components:{FMultiSelect:c,LFormFieldLabel:u,LFormFieldDescription:f,FError:m,LIcon:v,FText:p},setup(){const r=t(n.field),s=t(n.modelValue),o=t(n.error),d=t(n.required);return{selectModel:s,field:r,error:o,required:d,onLoadItems:l(async a=>{console.log("onLoadItems: ",a);try{await fetch("https://jsonplaceholder.typicode.com/users").then(async e=>{const i=await e.json();if(!e.ok)throw i;return i}).then(e=>r.value.items=e)}catch(e){o.value=e}},"onLoadItems"),iChevronDown:b,iCheck:h,iClose:g}},template:`
  <div class="py-16 bg-s-200 dark:bg-s-900">
    <div class="max-w-lg mx-auto p-4 rounded-md bg-white dark:bg-s-800 shadow-xl">
      <FMultiSelect
        :is="field.component"
  ...
  `}),"Default"),y=k.bind({});y.args={modelValue:[],field:x,error:"",required:!0};const w={id:"friends",name:"friends",component:"FMultiSelect",keyValue:"id",keyLabel:"title",keyGroup:"category",autofocus:!0,multiple:!0,label:"Your friends",description:"Choose friends your know",placeholder:"Choose friends",items:[],vtype:"array",rules:[{type:"required",params:["This field is required"]},{type:"length",params:[1,"Languages cannot be less than 1 language"]}]},I=l(n=>({components:{FMultiSelect:c,LFormFieldLabel:u,LFormFieldDescription:f,FError:m,LIcon:v,FText:p},setup(){const r=t(n.field),s=t(n.modelValue),o=t(n.error),d=t(n.required);return{selectModel:s,field:r,error:o,required:d,onLoadItems:l(async a=>{console.log("onLoadItems: ",a);try{await fetch("https://dummyjson.com/products").then(async e=>{const i=await e.json();if(!e.ok)throw i;return i}).then(e=>r.value.items=e.products)}catch(e){o.value=e}},"onLoadItems"),iChevronDown:b,iCheck:h,iClose:g}},template:`
  <div class="py-16 bg-s-200 dark:bg-s-900">
    <div class="max-w-lg mx-auto p-4 rounded-md bg-white dark:bg-s-800 shadow-xl">
      <FMultiSelect
        :is="field.component"
  ...
  `}),"WithImages"),q=I.bind({});q.args={modelValue:[],field:w,error:"",required:!0};const $=["InputMultiSelect","InputwithImageMultiSelect"];export{y as InputMultiSelect,q as InputwithImageMultiSelect,$ as __namedExportsOrder,T as default};
//# sourceMappingURL=LMultiSelect.stories.c1adec19.js.map
