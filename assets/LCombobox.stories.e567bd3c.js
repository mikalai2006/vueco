...
`,locationsMap:{combobox:{startLoc:{col:16,line:28},endLoc:{col:2,line:129},startBody:{col:16,line:28},endBody:{col:2,line:129}},"combobox-simple-data":{startLoc:{col:15,line:169},endLoc:{col:2,line:236},startBody:{col:15,line:169},endBody:{col:2,line:236}}}},vitest:{testFile:"FCombobox.spec.ts",testResults:M}}},E=r(e=>({components:{FCombobox:i,LFormFieldLabel:d,LFormFieldDescription:u,FError:p,LIcon:b,FText:c},setup(){const n=o(e.field),a=o(e.modelValue),s=o(e.error),l=o(e.required);return{selectModel:a,field:n,error:s,required:l,onLoadItems:r(async()=>{try{await fetch("https://jsonplaceholder.typicode.com/users").then(async t=>{const m=await t.json();if(!t.ok)throw m;return m}).then(t=>n.value.items=t)}catch(t){s.value=t}},"onLoadItems"),iChevronDown:f,iCheck:F,iClose:x,onInput:e.onInput,onChoose:e.onChoose}},template:`
  <div class="py-16">
    <div class="max-w-lg mx-auto p-4 rounded-md bg-s-100 dark:bg-s-800 shadow-xl">
      <FCombobox
        v-model="selectModel"
  ...
  `}),"Default"),_={autocomplete:"both",id:"friends",name:"friends",component:"FCombobox",keyValue:"name",keyLabel:"name",keyFilter:"name",autofocus:!0,multiple:!0,label:"Your friends",description:"Choose friends your know",placeholder:"Choose friends",items:[],vtype:"array",rules:[{type:"required",params:["This field is required"]},{type:"length",params:[1,"Languages cannot be less than 1 language"]}]},V=E.bind({});V.args={modelValue:[],field:_,error:"",required:!0};const N=r(e=>({components:{FCombobox:i,LFormFieldLabel:d,LFormFieldDescription:u,FError:p,LIcon:b,FText:c},setup(){const n=o(e.field),a=o(e.modelValue),s=o(e.error),l=o(e.required);return{selectModel:a,field:n,error:s,required:l,iChevronDown:f,iCheck:F,iClose:x}},template:`
  <div class="py-16">
    <div class="max-w-lg mx-auto p-4 rounded-md bg-s-100 dark:bg-s-800 shadow-xl">
      <FCombobox
        v-model="selectModel"
...
//# sourceMappingURL=LCombobox.stories.e567bd3c.js.map
