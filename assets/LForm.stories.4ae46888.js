...
// </FButton>
// </div>
`,locationsMap:{default:{startLoc:{col:23,line:383},endLoc:{col:2,line:532},startBody:{col:23,line:383},endBody:{col:2,line:532}}}}},title:"Components/Form",component:V},be=s(()=>({components:{LForm:V,LFormField:N,LFormFieldLabel:M,LFormFieldDescription:R,LIcon:I,FSpinner:H,FError:x,FText:G,FTextarea:w,FCheckbox:q,FNumber:B,FMultiSelect:O,FCombobox:U,FButton:K},setup(){const n=y({email:"",name:"Name",languages:["Karianne"],friend:"Nicholas Runolfsdottir V",male:!1,accept:!1,comments:!0}),{errors:u,onValidate:p,onCreateSchema:r,onFormValidate:a}=P(),i=s(async()=>{await a(n.value),l.value&&(console.group("Save form"),console.log(n.value),console.groupEnd())},"onSaveForm");Z(async()=>{await r(C)});const l=F(()=>Object.keys(u.value).length===0);return{errors:u,forms:n,formData:C,onSaveForm:i,onInput:s(async t=>{await p(t.name,n.value)},"onInput"),iClose:_,iChat:ne}},template:`
  <div class="py-16 bg-s-200 dark:bg-s-900">
      <LForm
        v-model="forms"
        :schema="formData"
...
//# sourceMappingURL=LForm.stories.4ae46888.js.map
