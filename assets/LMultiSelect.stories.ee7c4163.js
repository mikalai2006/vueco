var u=Object.defineProperty;var l=(e,t)=>u(e,"name",{value:t,configurable:!0});import{r as o}from"./vue.esm-bundler.d6e8a8ce.js";import{_ as r}from"./FMultiSelect.fd937d66.js";import{_ as p,a as m}from"./FText.23a6b47a.js";import{L as f,a as g}from"./LForm.f2b6a216.js";import{L as h}from"./LIcon.b157f1df.js";import{i as v,a as L,b,c as S}from"./useIcon.1f824c76.js";import"./LSpinner.c9659ed3.js";const D={parameters:{storySource:{source:`import { onMounted, ref } from "vue";
...
`,locationsMap:{"input-multi-select":{startLoc:{col:16,line:48},endLoc:{col:2,line:185},startBody:{col:16,line:48},endBody:{col:2,line:185}}}}},title:"Components/FMultiSelect",component:r},M={id:"friends",name:"friends",component:"FMultiSelect",keyValue:"id",keyLabel:"name",keyGroup:"username",keyFilter:"name",autofocus:!0,multiple:!0,label:"Your friends",description:"Choose friends your know",placeholder:"Choose friends",items:[],vtype:"array",rules:[{type:"required",params:["This field is required"]},{type:"length",params:[1,"Languages cannot be less than 1 language"]}]},x=l(e=>({components:{FMultiSelect:r,LFormFieldLabel:f,LFormFieldDescription:g,FError:p,LIcon:h,FText:m},setup(){const t=o(e.field),i=o(e.modelValue),a=o(e.error),c=o(e.required);return{selectModel:i,field:t,error:a,required:c,onLoadItems:l(async d=>{console.log("onLoadItems: ",d);try{await fetch("https://jsonplaceholder.typicode.com/users").then(async n=>{const s=await n.json();if(!n.ok)throw s;return s}).then(n=>t.value.items=n)}catch(n){a.value=n}},"onLoadItems"),iChevronDown:v,iCheck:L,iClose:b,iFunnel:S}},template:`
  <div class="min-h-screen py-16 bg-s-200 dark:bg-s-900">
    <div class="max-w-lg mx-auto p-4 rounded-md bg-white dark:bg-s-800 shadow-xl">
      <FMultiSelect
        :is="field.component"
  ...
  `}),"Default"),y=x.bind({});y.args={modelValue:[],field:M,error:"",required:!0};const z=["InputMultiSelect"];export{y as InputMultiSelect,z as __namedExportsOrder,D as default};
//# sourceMappingURL=LMultiSelect.stories.ee7c4163.js.map
